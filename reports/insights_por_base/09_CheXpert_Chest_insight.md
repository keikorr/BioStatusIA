# Insight Clínico & Técnico — 09_CheXpert_Chest

**Família:** F3  
**Descrição:** Radiografia de tórax frontal DICOM 2D  
...
**Laudo Radiológico DICOM 2D (F3):** Imagens do exame '09_CheXpert_Chest' lidas via PyDicom. Modelo **SVM** (AUC=1.00).

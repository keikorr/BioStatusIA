# Insight Clínico & Técnico — 13_BraTS_Brain_MRI_3D

**Família:** F4  
**Descrição:** Ressonância Magnética 3D Encefálica (Glioblastoma)  
...
**Laudo Volumétrico 3D (F4):** Processamento 3D do exame '13_BraTS_Brain_MRI_3D'. Modelo **SVM** (AUC=0.67).
